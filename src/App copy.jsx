      ...
      {!modelsReady ? (
        <div className="fixed inset-0 flex items-center justify-center">
          <div className="text-center p-8">
            ...
            <p className="text-white">Loading translation engine...</p>
          </div>
        </div>
      ) : (
        <div className="relative z-10 container mx-auto px-4 sm:px-6 py-8 max-w-4xl space-y-8">
          <div className="text-center space-y-4">
            <h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-accent-400 via-blue-400 to-accent-600 bg-clip-text text-transparent">
              AI-Powered Real-Time Translator
            </h1>
            <p className="text-primary-300 text-lg">
              {mode === 'translate' 
                ? 'Professional meeting translation' 
                : 'AI-enhanced speech transcription'}
            </p>
          </div>
